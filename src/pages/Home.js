  ...
  const slides = [
    {
      ...
      image: `${process.env.PUBLIC_URL}/images/educacao.jpg`
    },
    {
      ...
      image: `${process.env.PUBLIC_URL}/images/Walnews_1.png`
    },
    {
      type: "Infraestrutura",
      ...
      image: `${process.env.PUBLIC_URL}/images/Walobras_2.png`
    }
  ];
  ...
  return (
    <main className={styles.main}>
      ...
      <section className={styles.heroBanner}>
        <img
          src={`${process.env.PUBLIC_URL}/images/Panel_3.png`}
      ...
      <section className={styles.sliderSection}>
        <div className={styles.contentWrapper}>
          {slides.map((slide, index) => (
            <article
              key={index}
              className={`${styles.sliderArticle} ${index === currentSlide ? styles.sliderArticleActive : ""}`}
      ...
      <section className={styles.bioSection}>
        <div className={styles.contentWrapper}>
          ...
          <img src={`${process.env.PUBLIC_URL}/images/bio12.png`} alt="Waldenor Pereira" className={styles.bioFullImage} />
